...
class WebToPay {
     ...
     *
     * Possible keys:
     * https://www.paysera.lt/makro_specifikacija.html
     *
    ...
    public static function getPaymentUrl($language = 'LIT') {
        $url = self::PAY_URL;
        if ($language != 'LIT') {
            $url = str_replace('paysera.com', 'webtopay.com', $url);
        }
        return $url;
    }
     ...
     * makro: https://www.paysera.lt/makro_specifikacija.html
     * mikro: https://www.paysera.lt/mikro_mokejimu_specifikacija_SMS.html
     *
